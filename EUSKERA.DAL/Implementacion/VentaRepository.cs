...
namespace EUSKERA.DAL.Implementacion
{
    public class VentaRepository : GenericRepository<Venta>, IVentaRepository
    {
        private readonly EUSKERA_DBContext _dbContext;

        public VentaRepository(EUSKERA_DBContext dbContext):base(dbContext)
        {
                ...
                using(var transaction= _dbContext.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        foreach (DetalleVenta dv in entidad.DetalleVenta)
                        {
                            ...
                            Producto producto_encontrato = _dbContext.Producto.Where(p=>p.IdProducto==dv.IdProducto).First();
                        ...
                        NumeroCorrelativo correlativo = _dbContext.NumeroCorrelativo.Where(n => n.Gestion == "venta").First();
